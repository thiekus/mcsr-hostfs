...
* Copy all CD contents into new directory named `mc`.
...
* Delete `CARS.DAT`, `COMMON.DAT`, `FRONTEND.DAT`, `L01.DAT` and `M01.DAT`. Also delete newly created folders of each archives such `CARS`, `COMMON`, `FRONTEND`, `L01` and `M01`.
